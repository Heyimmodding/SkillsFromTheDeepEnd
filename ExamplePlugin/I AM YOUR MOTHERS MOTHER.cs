...
namespace ExamplePlugin
{
	...
	public class Splitter : BaseSkillState
	{
			...
			if (base.isAuthority)
			{
				...
				if (Charge >= ChargeThreshold)
                {
					new BulletAttack
					{
						...
						minSpread = 5f,
						maxSpread = 10f,
						damage = Splitter.ChargedDamageCoefficient * this.damageStat,
		...
		public static GameObject tracerEffectPrefab = Resources.Load<GameObject>("prefabs/effects/tracers/tracerhuntressnipe");
		...
		public static GameObject hitEffectPrefab = Resources.Load<GameObject>("prefabs/effects/impacteffects/magmaorbexplosion"); //("prefabs/effects/omnieffect/OmniImpactVFXBrotherLunarShardExplosion");

		// Token: 0x04003E70 RID: 15984
		public static float damageCoefficient = 2f;

		public static float ChargedDamageCoefficient = 1f;
		// Token: 0x04003E71 RID: 15985
		public static float force = 650f;

		public static float ChargeThreshold = 2f;
